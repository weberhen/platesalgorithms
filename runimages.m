...
fileID = fopen('/home/hweber/Videos/filmagens_rua/dados/cristiano_fischer_1010.txt');
...
while ~feof(fileID)
   ...
   name=strcat('/home/hweber/Videos/filmagens_rua/dados/frames_cristiano_fischer_1410/',num2str(j),'.png');
