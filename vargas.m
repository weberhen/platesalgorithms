...
v = zeros([height 1]);
for i = 1 : height, v(i) = var(im2double(img_density(i , :)));
end
...
for i = 1 : length_r_final,
    for j = 1 : width, v(i, j) = var(im2double(img_density(r_upp_final(i) : ...
            r_bot_final(i), j)));
    end
end
